...
export default function Home() {
  ...
  return <main className="screen dashboard">
    ...
    {!materiasAbertas && <><section className="home-create"><h3 className="section-title">Adicionar Novo Estímulo</h3><MaterialActions setModal={setModal} fotoInput={fotoInput} documentoInput={documentoInput} abrirModalLink={abrirModalLink} /></section><section className="home-actions"><p className="home-actions-copy">Acesse o seu acervo organizado por matérias e subpastas.</p><button type="button" className="btn-materias bg-synapse-primary text-white" onClick={() => { setMateriasAbertas(true); setPastaAtual(null); }}><span aria-hidden="true">📁</span> Acessar Matérias Criadas</button></section></>}
